  ...
  return (
    ...
    >
      <img
        ...
        alt=""
      />
      <div className="hidden bg-[rgb(255,255,255, 4%)] p-10 text-white gap-5  md:flex">
      <NavLink to= {"/"} 
      className={({isActive})=>
      ...
      <div className="md:hidden">
        ...
        {show && (
          <div className="bg-transparent w-[70%] text-white backdrop-blur-lg uppercase gap-7 flex flex-col barlow-condensed-regular items-start right-0 text-base  pl-5 pr-20 top-0 pt-36 h-screen absolute ">
